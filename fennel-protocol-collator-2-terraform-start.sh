...
sudo certbot --nginx --non-interactive --agree-tos --email info@fennellabs.com --domains node-2.fennellabs.com
...
docker exec fennel-collator-2 /app/target/release/fennel-node --collator --force-authoring --chain raw-parachain-chainspec.json --base-path /tmp/parachain/alice --port 40333 --ws-port 9944 --telemetry-url "wss://telemetry.polkadot.io/submit/ 0" --rpc-methods Unsafe --name Fennel1 --bootnodes  /ip4/34.23.178.177/tcp/40333/p2p/12D3KooWB1F4pxwVCfyDRu5jU4RaUv3ESmCrkd4aXf5noFsxLPvx --unsafe-ws-external --rpc-external --rpc-cors=all -- --execution wasm --chain /app/polkadotspec.json --port 30343 --ws-port 9977 --rpc-port 9934 --bootnodes /ip4/34.138.37.11/tcp/30333/p2p/12D3KooWLj8FgbwDtLQbA5ozWqqx6vM1n2rmjwQMczSiDveyWa5G --rpc-external --ws-external --prometheus-external --rpc-cors all