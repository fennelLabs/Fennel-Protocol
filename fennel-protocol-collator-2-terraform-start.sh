...
docker run -it -p 40333:40333 -p 8844:8844 -p 30343:30343 -p 9977:9977 --name fennel-collator-2 us-east1-docker.pkg.dev/whiteflag-0/fennel-docker-registry/fennel-protocol:latest
