...
impl<T: frame_system::Config> pallet_fennel_identity::WeightInfo for WeightInfo<T> {
	...
	fn create_identity(_s: u32, ) -> Weight {
		Weight::from_ref_time(18_584_585 as u64)
	...
	fn revoke_identity(s: u32, ) -> Weight {
		Weight::from_ref_time(19_734_191 as u64)
			// Standard Error: 0
	...
	fn add_or_update_identity_trait(_s: u32, ) -> Weight {
		Weight::from_ref_time(19_458_415 as u64)
			.saturating_add(T::DbWeight::get().reads(2 as u64))
	...
	fn remove_identity_trait(s: u32, ) -> Weight {
		Weight::from_ref_time(18_437_990 as u64)
			// Standard Error: 1
			.saturating_add(Weight::from_ref_time(9 as u64).saturating_mul(s as u64))
	...
	fn sign_for_identity(_s: u32, ) -> Weight {
		Weight::from_ref_time(21_989_800 as u64)
			.saturating_add(T::DbWeight::get().reads(2 as u64))
			.saturating_add(T::DbWeight::get().writes(2 as u64))
	}
}
