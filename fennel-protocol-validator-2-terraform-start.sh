...
docker exec fennel-validator-2 /app/target/release/polkadot --validator --base-path /tmp/relay/charlie --chain /app/chainspec.json --port 30333 --ws-port 9944 --rpc-port 9934 --bootnodes /ip4/34.138.37.11/tcp/30333/p2p/12D3KooWLj8FgbwDtLQbA5ozWqqx6vM1n2rmjwQMczSiDveyWa5G --telemetry-url "wss://telemetry.polkadot.io/submit/ 0" --rpc-methods Unsafe --name FnlDot2 --rpc-external --ws-external --prometheus-external --rpc-cors all -lparachain::collator-protocol=trace
