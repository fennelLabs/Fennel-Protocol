...
use fennel_runtime::{AccountId, AuraId, Signature, EXISTENTIAL_DEPOSIT};
...
pub type ChainSpec =
	sc_service::GenericChainSpec<fennel_runtime::RuntimeGenesisConfig, Extensions>;
...
pub fn template_session_keys(keys: AuraId) -> fennel_runtime::SessionKeys {
	fennel_runtime::SessionKeys { aura: keys }
}

pub fn development_config() -> ChainSpec {
	// Give your base currency a unit name and decimal places
	let mut properties = sc_chain_spec::Properties::new();
    properties.insert("tokenSymbol".into(), "FENL".into());
...
fn testnet_genesis(
	...
	fennel_runtime::RuntimeGenesisConfig {
		...
		session: fennel_runtime::SessionConfig {
			keys: invulnerables
				.into_iter()
				.map(|(acc, aura)| {
					(
