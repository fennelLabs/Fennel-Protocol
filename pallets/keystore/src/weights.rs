...
impl<T: frame_system::Config> WeightInfo for SubstrateWeight<T> {
    ...
    fn announce_key() -> Weight {
        Weight::from_parts(11_000_000, 0).saturating_add(T::DbWeight::get().writes(1_u64))
    }
    /// Storage: Keystore IssuedKeys (r:0 w:1)
    /// Proof Skipped: Keystore IssuedKeys (max_values: None, max_size: None, mode: Measured)
    fn announce_key_with_long_vectors() -> Weight {
    ...
    /// Proof: Keystore IssuedEncryptionKeys (max_values: None, max_size: Some(80), added: 2555,
    /// mode: MaxEncodedLen)
    fn issue_encryption_key() -> Weight {
